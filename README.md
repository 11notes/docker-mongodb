...
| ---: | ---: | :---: | :---: | :---: |
| 11notes/mongodb | 344MB | 1000:1000 | ❌ | amd64 |
| mongo | 594MB | 0:0 | ❌ | amd64, arm64v8 |
...
services:
  mongodb:
    ...
    tmpfs:
      # needed because the image runs read-only
      - "/mongodb/run:uid=1000,gid=1000"
    restart: "always"
...
*created 19.02.2026, 18:33:00 (CET)*